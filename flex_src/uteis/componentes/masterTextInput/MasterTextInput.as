package uteis.componentes.masterTextInput
{
...
[IconFile("imagens/componente/masterTextInput/mastertextinput.png")]
public class MasterTextInput extends TextInput
{
	...
	*/
	 ...
	 *  Add Clear Button
	 */
	protected function addClearButton(event:FlexEvent):void{
		if(clearButton == null){
